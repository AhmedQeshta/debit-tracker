...
export const useAccount = () => {
  ...
  const updateEmail = async (newEmail: string) => {
    ...
    try {
      ...
      toastInfo(
        'We sent a verification code to your new email address. Please check your inbox and verify the email. To complete email verification, please check your email and use the verification code in the Clerk dashboard or web portal.',
      );
    } catch (error: any) {
